# S206 -- Extension Provenance Record

**Series**: S206 -- Business Cycles, 1903-1939 (Ayres Index, Fig 2.4C)
**Phase**: 6 (Extension)
**Construction classification**: `direct`
**Extension status**: `discontinued`
**Authored**: 2026-05-18
**Author**: opus-subagent-wave2-ch2
**Related**: `S206_DPR.md`, `Technical/research/S206_research.json`

---

## 1. Classification

Per the playbook content-type rule, S206 is classified `direct`. Extension recipe applied: per the Anu framework rule on lazy splices, this dictates the extension method below.
...
CD2's predecessor series may diverge from S206 due to (a) different extension anchor, (b) different proxy selection, or (c) a different vintage of the underlying source. Divergence is reported informationally in V03 and never causes a FAIL.
