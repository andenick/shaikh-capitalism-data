...
**Data Provenance Record · Ingestion stage · Chapter 14 · Figure 14.16 · Authored 2026-05-18**

## 1. Definition
HP(100) (Hodrick-Prescott filter, smoothing parameter lambda=100) phase plot: y = real-wage growth `wr = (EC*100/FEE)/p` (FEE = full-time-equivalent employees), x = intensity.
...
*Each series is built from sub-components identified by a suffix on the series ID (for example, S1407-A, S1407-B); they are listed below.*
...
## 4. Construction
Direct pass-through. The processing step additionally fits two-era Phillips curves
...
## 8. Cross-references
Predecessor build: `S074`. Book p. 670. Equation 14.18.
