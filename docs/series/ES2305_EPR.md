# ES2305 — Extension Provenance Record

**Series**: ES2305 — RMB Misalignment, Macro-Balance Approach (Literature Compilation)
**Phase**: 6 (Extension)
**Construction**: `composite` (literature compilation)
**Extension status**: `not_applicable_literature_compilation`
**Authored**: 2026-05-18

Identical reasoning as ES2304_EPR (same 4 cited reviews, same
...
## Methodology distinction from ES2304

Both ES2304 and ES2305 sample from the same 4 reviews. The split is
on the underlying estimate's equilibrium-RER methodology:
- ES2304 = extended PPP / BEER
- ES2305 = macroeconomic balance / current-account norm (Williamson 1994)
...
- Source agency choice: identical to ES2304 — the same four literature
...
- Disambiguation: macroeconomic-balance (ES2305) is methodologically
  distinct from extended-PPP (ES2304) even when both are sampled from
