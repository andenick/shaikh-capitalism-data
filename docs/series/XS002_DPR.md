# XS002 — Wage Equivalent and Corp/Noncorp Split (Data Provenance Record)
...
WEQ2 = (sigma*PropInc - ECprop)/(1+sigma). Source: Appendix Table 6.8.I.2. Used by XS003 / S603. See `CH6_GPIM_SUMMARY.md` for the full Ch6 construction pipeline.

## Sources (per subseries)

| Subseries | Appendix Table | Variable | Source agency | Notes |
|-----------|---------------|----------|---------------|-------|
| XS002-A | I2 | `PropInc` | BEA NIPA / BEA FA / IRS SOI / Census | identity |
| XS002-B | I2 | `ECprop` | BEA NIPA / BEA FA / IRS SOI / Census | identity |
| XS002-C | I2 | `WEQ2` | BEA NIPA / BEA FA / IRS SOI / Census | identity |
| XS002-D | I2 | `WEQ1` | BEA NIPA / BEA FA / IRS SOI / Census | identity |
| XS002-E | I2 | `Pnoncorp` | BEA NIPA / BEA FA / IRS SOI / Census | identity |
| XS002-F | I2 | `Pcorpnipa` | BEA NIPA / BEA FA / IRS SOI / Census | identity |
| XS002-G | I2 | `s` | BEA NIPA / BEA FA / IRS SOI / Census | identity |
...
Book period: 1947-2011. Vintage-stable extension recipe in `XS002_EPR.md`.
