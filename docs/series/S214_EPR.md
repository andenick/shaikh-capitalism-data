...
**Series**: S214 -- Average Rates of Profit in US Manufacturing, 1960-1989
**Phase**: 6 (Extension)
**Construction classification**: `formula`
**Extension status**: `data_unavailable`
**Authored**: 2026-05-18
**Author**: opus-subagent-wave2-ch2
**Related**: `S214_DPR.md`, `Technical/research/S214_research.json`

---

## 1. Classification

Per the playbook content-type rule, S214 is classified `formula`. Extension recipe applied: per the Anu framework rule on lazy splices, this dictates the extension method below.

## 2. Method

OECD STAN with sector crosswalk + BEA GDP-by-industry + Fixed-Asset Tables; deferred.
...
CD2's predecessor series may diverge from S214 due to (a) different extension anchor, (b) different proxy selection, or (c) a different vintage of the underlying source. Divergence is reported informationally in V03 and never causes a FAIL.
