# S211 -- Extension Provenance Record

**Series**: S211 -- US and UK Wholesale Price Indexes, 1780-1940 (1930=100, log scale)
**Phase**: 6 (Extension)
**Construction classification**: `composite`
**Extension status**: `not_applicable_windowed`
**Authored**: 2026-05-18
**Author**: opus-subagent-wave2-ch2
**Related**: `S211_DPR.md`, `Technical/research/S211_research.json`

---

## 1. Classification

Per the playbook content-type rule, S211 is classified `composite`. Extension recipe applied: per the Anu framework rule on lazy splices, this dictates the extension method below.
...
CD2's predecessor series may diverge from S211 due to (a) different extension anchor, (b) different proxy selection, or (c) a different vintage of the underlying source. Divergence is reported informationally in V03 and never causes a FAIL.

## 7. Extension status

Current: `not_applicable_windowed`. See DPR caveats for rationale.
