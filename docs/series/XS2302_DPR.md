...
|---|---|---|---|---|
| XS2302-level | 1997–2024 | IMF WEO subject `BCA` for country `CHN` | Billion current USD | IMF Datamapper JSON API (`imf.org/external/datamapper/api/v1/BCA/CHN`) |
...
Per CHES_v2 D4: **emit as two AnuData rows (XS2302-level and
XS2302-pctgdp), not one mixed-unit series.** The figure plots them on
...
- Dossier: `Technical/research/XS2302_research.json`
