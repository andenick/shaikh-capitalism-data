...
| UEMPMEAN 2011 break | data semantics | Documented; no adjustment per the data-adequacy review |
...
Minimal expected (<1%). The predecessor build used the same FRED series.
