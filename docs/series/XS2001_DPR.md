...
|---|---|---|---|---|
| XS2001-circ-* | 1947, 1958, 1963, 1967, 1972, 1998 | Shaikh (2020) Table 1 (circulating capital) | dimensionless ratio | `SalvagedInputs/book_data/Reconstructed/XS2001_aggregate_ratios.csv` |
| XS2001-fixed-* | same 6 years | Shaikh (2020) Table 2 (fixed capital) | dimensionless ratio | same CSV |
...
Appendix for physical bundles. Per CHES adequacy: XS2001 and XS2101
...
4. The paper's Figures 1-9 (403-sector cross-sectional curves) are
   NOT in this series; see XS2001_EPR §3 for v1.1 plan.

## 8. Cross-references

- Dossier: `Technical/research/XS2001_research.json`
- Companion: `XS2101` (Shaikh-Coronado-Nassif-Pires 2020, 295-matrix
  CI distribution) — shares BEA-to-Sraffa pipeline
- Reconstructed: `SalvagedInputs/book_data/Reconstructed/XS2001_aggregate_ratios.csv`
