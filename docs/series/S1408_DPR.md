...
**Data Provenance Record · Ingestion stage · Chapter 14 · Figure 14.17 · Authored 2026-05-18**

## 1. Definition
HP(100) (Hodrick-Prescott filter, smoothing parameter lambda=100) phase plot: y = nominal-wage growth where `w = EC*100/FEE` (FEE = full-time-equivalent employees), x = intensity.
...
*Each series is built from sub-components identified by a suffix on the series ID (for example, S1408-A, S1408-B); they are listed below.*
...
## 4. Construction
Direct pass-through. The processing step additionally:
...
4. Sample-window off-by-one: text says 1948-1982; Appendix Stata output and
   differencing both start at 1949. This build uses 1949-1982.

## 8. Cross-references
Predecessor build: `S075`. Book p. 670-672. Equation 14.19. Table 14.3.
