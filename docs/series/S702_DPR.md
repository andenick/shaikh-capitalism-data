...
- Registry entry: series registry → `series.S702`
- Subsource registry: subsource registry → `SALTER_1969_TABLE33_UK`

---

## 1. Definition

**S702** is the **cross-sectional industry scatter** that Shaikh re-plots in Fig7.12 from Salter (1969). Each point is one UK industry; both axes are the ratio (1963/1954 × 100; selling price and unit labour cost). Period: 1954–1963. The source is **Salter 1969, p. 197, table 33** (the UK panel appears in the posthumous Reddaway Addendum).

> **ERRATUM — Salter caption transposition.** The book's Fig 7.11/7.12 *captions* transpose the two Salter tables (the Fig 7.12 caption prints "Source: Salter 1969, 164, table 28"). This is a caption erratum. The authoritative mapping comes from the salvaged workbook Row-0 title ("Table 33. Changes over the period 1954-63 for selected United Kingdom industries - (Index numbers 1954 = 100)") and the book body text listing the two data sets as "(164, table 28; 197, table 33)": **UK Fig 7.12 = Table 33, p.197; US Fig 7.11 = Table 28, p.164.** Corrected 2026-07-02 (campaign DF-2); this reverses the 2026-06-11 reconciliation, which had elevated the erratum captions.
...
- **Knowledge Base**: figure-linkage reference → `Fig7.12`.
...
- **Subseries (S702-A)** — the single data line within series S702 (one row per industry, carrying the selling-price and unit-labour-cost ratios).
...
- **CD2** — the predecessor build of this dataset (legacy ID S031).
