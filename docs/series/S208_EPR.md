# S208 -- Extension Provenance Record

**Series**: S208 -- US Manufacturing Real Unit Production Labor Cost Index, 1889-2025
**Phase**: 6 (Extension)
**Construction classification**: `formula`
**Extension status**: `feasible`
**Authored**: 2026-05-18
**Author**: opus-subagent-wave2-ch2
**Related**: `S208_DPR.md`, `Technical/research/S208_research.json`

---

## 1. Classification

Per the playbook content-type rule, S208 is classified `formula`. Extension recipe applied: per the Anu framework rule on lazy splices, this dictates the extension method below.

## 2. Method

Recompute formula with extended S207 components (per playbook formula recipe).
...
CD2's predecessor series may diverge from S208 due to (a) different extension anchor, (b) different proxy selection, or (c) a different vintage of the underlying source. Divergence is reported informationally in V03 and never causes a FAIL.
