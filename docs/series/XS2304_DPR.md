# XS2304 — RMB Misalignment Estimates, Extended PPP Approach (Literature Compilation)
...
XS2304 is the scatter compilation of RMB misalignment estimates that
...
|---|---|---|---|---|
| XS2304-A | 1999–2010 | Literature compilation per paper note 17 | percent | `SalvagedInputs/book_data/Reconstructed/XS2304_literature_compilation.csv` |
...
Subseries `XS2304-A` aggregates all extended-PPP estimates.
...
- Dossier: `Technical/research/XS2304_research.json`
- Companion: `XS2305` (macro-balance approach, same 4 reviews)
- Reconstructed: `SalvagedInputs/book_data/Reconstructed/XS2304_literature_compilation.csv`
