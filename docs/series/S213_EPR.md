# S213 -- Extension Provenance Record

**Series**: S213 -- US Corporate Rate of Profit, 1947-2011
**Phase**: 6 (Extension)
**Construction classification**: `formula`
**Extension status**: `deferred`
**Authored**: 2026-05-18
**Author**: opus-subagent-wave2-ch2
**Related**: `S213_DPR.md`, `Technical/research/S213_research.json`

---

## 1. Classification

Per the playbook content-type rule, S213 is classified `formula`. Extension recipe applied: per the Anu framework rule on lazy splices, this dictates the extension method below.

## 2. Method

Recompute NOS_corp / K_net from BEA NIPA T1.14 + FA T4.1; line resolver work pending.
...
CD2's predecessor series may diverge from S213 due to (a) different extension anchor, (b) different proxy selection, or (c) a different vintage of the underlying source. Divergence is reported informationally in V03 and never causes a FAIL.
