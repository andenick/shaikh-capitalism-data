...
`theoretical`; integrated Engel curve under Case II.
...
x(0)=5, x(60)~6.93 with our calibration; saturating.

## 4. No-Proxy disclosure

No proxy substitution. See `S305_DPR.md` for source details.
