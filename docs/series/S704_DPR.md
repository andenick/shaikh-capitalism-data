# S704 — Figure 7.14 — US Manufacturing ROP and IROP, 1960–1989 (Christodoulopoulos/ISDB US subset)
...
**Related artifacts**:
- Research dossier: `Technical/research/S704_research.json`
- Adequacy: `Technical/docs/chapters/CH7_ADEQUACY_REPORT.json`
- Extension Provenance Record: `Technical/docs/series/S704_EPR.md`
- Registry entry: `Technical/series_registry.json` → `series.S704`
- Subsource registry: `Technical/SUBSOURCE_METADATA.json` → `CHRISTODOULOPOULOS_1995_FIG7_14`

---

## 1. Definition

**S704** is the time-series exhibit Shaikh displays in Fig7.14. Period: 1960–1989.
...
|---|---|---|---|
| (none — chart-only) | 1960–1989 | CHRISTODOULOPOULOS_1995_FIG7_14 | **data_unavailable** |
...
rate (decimal; book displays percent).
...
- **CD legacy ID**: `S033`
- **Book reference**: Shaikh (2016), Ch. 7 (Fig7.14); Appendix 7.1 II / IV (book pp. 856, 859).
