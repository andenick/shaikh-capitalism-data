...
|---|---|---|---|---|
| XS2101-A | 2002, 2007 | Paper Section 5 (p. 272) verbatim summary statistics | dimensionless / counts / percent | `SalvagedInputs/book_data/Reconstructed/XS2101_summary_statistics.csv` |
...
skill-adjusted labor coefficients. Shared with XS2001 (v1.1 pipeline).
...
- Dossier: `Technical/research/XS2101_research.json`
- Companion: `XS2001` (Shaikh 2020 aggregate ratios) — shares BEA-to-Sraffa pipeline
- Reconstructed: `SalvagedInputs/book_data/Reconstructed/XS2101_summary_statistics.csv`
