...
`BEA_benchmark_IO_to_Sraffa_pipeline` module consumed by both XS2001
and XS2101. v1.1 implementation:
...
unreachable 2026-05-18. The canonical URL-of-record for XS2001 is
the archival PDF at:
