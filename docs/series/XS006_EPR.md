...
4. BEA 1993 depreciation/retirement rates are read from the reconstructed BEA 1993 Fixed Asset methodology inputs. Rate inputs freeze at 2011-vintage projection.

## Worked Example

For XS006, the round-trip validation reads the raw values from the Appendix 6.8 workbook and confirms bit-for-bit reproduction of the published series for the book period 1925-2011. A worked-example year (typically 2009 per book p. 842, or 2011 per Shaikh's last published vintage) verifies headline values.
