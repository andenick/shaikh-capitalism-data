...
**Series**: S1403 (Wage Share vs Unemployment Intensity) · **Chapter 14** · **Authored**: 2026-05-18
...
## Method
The Hodrick-Prescott (HP) filter (smoothing parameter lambda=100) is applied to the FULL extended quarterly sample (1948Q1-2024Q4), not
...
SAME underlying National Income and Product Accounts (NIPA) Table 1.10 line 2 / line 1 series; not a concept-changing
...
Minor (<2%) divergence expected on the quarterly axes vs the predecessor build because the predecessor build used
