# XS2305 — RMB Misalignment Estimates, Macroeconomic Balance Approach (Literature Compilation)
...
XS2305 is the scatter compilation of RMB misalignment estimates in
...
methodology, as opposed to the extended-PPP approach of XS2304.

Per paper note 17, XS2305 is compiled from the SAME 4 literature
reviews as XS2304:
...
|---|---|---|---|---|
| XS2305-A | 1999–2012 | Literature compilation per paper note 17 | percent | `SalvagedInputs/book_data/Reconstructed/XS2305_literature_compilation.csv` |

## 4. Construction

Same compilation rule as XS2304, with methodology filter set to
...
`not_applicable_literature_compilation` — see XS2304_EPR for full
...
Identical to XS2304: v1.0 captures only the two paper-text-named
...
- Dossier: `Technical/research/XS2305_research.json`
- Companion: `XS2304` (extended PPP, same 4 reviews)
