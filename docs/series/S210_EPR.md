...
**Series**: S210 -- US and UK Wholesale Price Indexes, 1780-2026 (Fig 2.8, log scale)

**Construction classification**: `composite`
**Extension status**: `feasible_with_substitute`
**Authored**: 2026-05-18
**Author**: Anu Framework pipeline
**Related**: `S210_DPR.md`, research dossier
...
BLS WPU00000000 (US) folded into S210-A, spliced to 2026; ONS PLLU (UK) folded into S210-B, spliced to 2022. Both extensions ship in the chopped (the earlier ONS-502 deferral is resolved in what ships). Both are growth-rate splices onto Jastram's 1930=100 basis, not proxy substitutions.
