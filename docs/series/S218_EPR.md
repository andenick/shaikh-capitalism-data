# S218 -- Extension Provenance Record
...
**Related**: `S218_DPR.md`, `Technical/research/S218_research.json`

---

## 1. Classification

Per the playbook content-type rule, S218 is classified `formula`. Extension recipe applied: per the Anu framework rule on lazy splices, this dictates the extension method below.

## 2. Method

Reapply Shaikh exclusion rule to MPD 2023 country panel; ratio rebases safely, levels need rescale.
...
CD2's predecessor series may diverge from S218 due to (a) different extension anchor, (b) different proxy selection, or (c) a different vintage of the underlying source. Divergence is reported informationally in V03 and never causes a FAIL.
