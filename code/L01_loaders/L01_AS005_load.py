"""L01_AS005_load — load Shaikh Appendix 6.8 columns for AS005 (GPIM Variant - BEA 2011 Reference (Pure GPIM Regenerator)).
...
NIPA / BEA FA / IRS / Census components are documented in AS005_EPR.md.

Source map (subseries_id -> (Appendix table, variable, scale)):
  AS005-A <- Appendix 6.8.II1 / variable 'KNCcorp''
  AS005-B <- Appendix 6.8.II1 / variable 'KNCcorpbea'
  AS005-C <- Appendix 6.8.II1 / variable 'KNCcorp'ratio'
...
SOURCE_MAP = {'AS005-A': ['II1', "KNCcorp'", 1.0], 'AS005-B': ['II1', 'KNCcorpbea', 1.0], 'AS005-C': ['II1', "KNCcorp'ratio", 1.0]}
