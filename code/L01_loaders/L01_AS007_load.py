"""L01_AS007_load — load Shaikh Appendix 6.8 columns for AS007 (GPIM Variant - IRS Adjusted).
...
NIPA / BEA FA / IRS / Census components are documented in AS007_EPR.md.

Source map (subseries_id -> (Appendix table, variable, scale)):
  AS007-A <- Appendix 6.8.II4 / variable 'KTHcorpirs' (scaled x0.001)
  AS007-B <- Appendix 6.8.II4 / variable 'KNCcorpbeaAdj'
  AS007-C <- Appendix 6.8.II4 / variable 'KNHcorpbeaAdj'
...
SOURCE_MAP = {'AS007-A': ['II4', 'KTHcorpirs', 0.001], 'AS007-B': ['II4', 'KNCcorpbeaAdj', 1.0], 'AS007-C': ['II4', 'KNHcorpbeaAdj', 1.0]}
