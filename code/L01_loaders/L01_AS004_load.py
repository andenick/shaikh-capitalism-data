"""L01_AS004_load — load Shaikh Appendix 6.8 columns for AS004 (GPIM Corporate Capital Stock (Operational Baseline)).
...
NIPA / BEA FA / IRS / Census components are documented in AS004_EPR.md.

Source map (subseries_id -> (Appendix table, variable, scale)):
  AS004-A <- Appendix 6.8.II5 / variable 'KNCcorp'
  AS004-B <- Appendix 6.8.II5 / variable 'KGCcorp'
  AS004-C <- Appendix 6.8.II5 / variable 'KNHcorp'
...
SOURCE_MAP = {'AS004-A': ['II5', 'KNCcorp', 1.0], 'AS004-B': ['II5', 'KGCcorp', 1.0], 'AS004-C': ['II5', 'KNHcorp', 1.0]}
