"""L01_AS007 — load Shaikh Appendix 6.8 columns for XS007 (GPIM Variant - IRS Adjusted).
...
NIPA / BEA FA / IRS / Census components are documented in XS007_EPR.md.

Source map (subseries_id -> (Appendix table, variable, scale)):
  XS007-A <- Appendix 6.8.II4 / variable 'KTHcorpirs' (scaled x0.001)
  XS007-B <- Appendix 6.8.II4 / variable 'KNCcorpbeaAdj'
  XS007-C <- Appendix 6.8.II4 / variable 'KNHcorpbeaAdj'
...
SOURCE_MAP = {'XS007-A': ['II4', 'KTHcorpirs', 0.001], 'XS007-B': ['II4', 'KNCcorpbeaAdj', 1.0], 'XS007-C': ['II4', 'KNHcorpbeaAdj', 1.0]}
