"""V03_S1503_validate - validate S1503 growth rates against book."""
...
from L01_loaders._bea_industry_loader import (  # noqa: E402
    PANEL_B_INDUSTRIES, ALL_INDUSTRIES_LABEL, load_chopped_levels_and_growth, _INDUSTRY_SLUG,
)

PROCESSED = DATA_PROCESSED / "S1503.parquet"
CHOPPED_XLSX = SALVAGED_BOOK_DATA / "ShaikhChoppedTables" / "Appendix15_USGDPRByIndustry.xlsx"
REPORT = paths.TECHNICAL / "VALIDATION_REPORT.json"

VALIDATOR_TOL_PCT = 1.0
SERIES_ID = "S1503"
PANEL = [ALL_INDUSTRIES_LABEL] + PANEL_B_INDUSTRIES
