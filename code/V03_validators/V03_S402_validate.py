"""V03_S402_validate — compare S402 processed parquet to Appendix 4.2 Table 4
per-hour cost columns. Tolerance 0.5%."""
...
def run() -> dict:
    ...
    row = {
        ...
        "comparison_basis": "Reconstructed Appendix_4_2_Table4.csv (per-hour cost columns)",
