"""P02_AS006 — construct XS006 from raw parquet (pass-through with cleaning).

Reads Technical/data/raw/XS006_raw.parquet (one row per (year, subseries_id))
and writes Technical/data/processed/XS006.parquet with the canonical
``year, value, subseries_id, source_id, units`` columns.

Construction: the Shaikh Appendix 6.8 chopped tables already contain the
finished XS006 columns; the loader applied unit normalization at fetch time
