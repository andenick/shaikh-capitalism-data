"""P02_S504_construct - concatenate US p' and US pG into S504 (book period only, v1)."""
...
IN_PPRIME = DATA_RAW / "S504_US_WPI_in_GOLD.parquet"
IN_PG = DATA_RAW / "S504_US_GOLD_PRICE_IDX.parquet"
OUT = DATA_PROCESSED / "S504.parquet"
