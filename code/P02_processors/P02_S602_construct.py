"""P02_S602_construct — construct S602 from raw parquet (pass-through with cleaning).

Reads Technical/data/raw/S602_raw.parquet (one row per (year, subseries_id))
and writes Technical/data/processed/S602.parquet with the canonical
``year, value, subseries_id, source_id, units`` columns.

Construction: the Shaikh Appendix 6.8 chopped tables already contain the
finished S602 columns; the loader applied unit normalization at fetch time
