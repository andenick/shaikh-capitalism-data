"""P02_ES2101_construct — pass-through for ES2101 summary stats."""
...
SERIES_ID = "ES2101"
IN = DATA_RAW / f"{SERIES_ID}_SUMMARY_STATS.parquet"
...
def run() -> dict:
    ...
    return {
        ...
        "extension": {"extension_status": "v1_1_deferred",
                      "reason": "Full 295-matrix CI/Theil distribution requires shared BEA-Sraffa pipeline"},
        "output": str(OUT),
    }
