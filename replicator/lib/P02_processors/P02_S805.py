"""P02_S805 — emit processed S805 (Demsetz 1963/1969 cross-sections)."""
...
IN = DATA_RAW / "S805_DEMSETZ_TABLE_4.parquet"
OUT = DATA_PROCESSED / "S805.parquet"
...
def run() -> dict:
    ...
    keep = ["year", "value", "subseries_id", "source_id", "units", "cr4_bin"]
    df = df[keep]
