"""P02_AS001 — construct XS001 from raw parquet (pass-through with cleaning).

Reads Technical/data/raw/XS001_raw.parquet (one row per (year, subseries_id))
and writes Technical/data/processed/XS001.parquet with the canonical
``year, value, subseries_id, source_id, units`` columns.

Construction: the Shaikh Appendix 6.8 chopped tables already contain the
finished XS001 columns; the loader applied unit normalization at fetch time
