"""P02_S214_construct - pass-through Appendix7 post-book mfg ROP averages.
Book period (1960-1989) is data_unavailable per L01 status.
"""
...
IN = DATA_RAW / "S214_APP7_INDUSTRY_AVG.parquet"
OUT = DATA_PROCESSED / "S214.parquet"
...
def run() -> dict:
    ...
    return {
        ...
        "extension": {"extension_status": "post_book_only",
                      "label": "Mfg-industry mean ROP 1987-2005 from Appendix 7"},
        "output": str(OUT),
    }
