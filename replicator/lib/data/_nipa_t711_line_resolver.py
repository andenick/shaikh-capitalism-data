...
#           row immediately after line 4, shifting EVERY subsequent line
#           by +1. In the pinned index below only line 4 is unchanged;
#           all other recipe lines shift +1 — including line 28 -> 29
#           (NOT just lines >= 44, as an earlier note imprecisely stated).
...
_T711_LINE_INDEX: dict[int, dict[str, int]] = {
    ...
    # Post-2018 Comprehensive Update. The BEA release notes inserted one new
    # monetary-interest row immediately after line 4, so every recipe line
    # EXCEPT line 4 shifts +1 (line 28 -> 29, 44 -> 45, ..., 91 -> 92).
    2018: {
        "domestic_business__financial_corporate__monetary_interest_paid": 4,
