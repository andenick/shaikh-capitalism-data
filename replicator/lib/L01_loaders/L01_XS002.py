...
Source map (subseries_id -> (Appendix table, variable, scale)):
  XS002-A <- Appendix 6.8.I2 / variable 'PropInc'
  XS002-B <- Appendix 6.8.I2 / variable 'ECprop'
  XS002-C <- Appendix 6.8.I2 / variable 'WEQ2'
  XS002-D <- Appendix 6.8.I2 / variable 'WEQ1'
  XS002-E <- Appendix 6.8.I2 / variable 'Pnoncorp'
  XS002-F <- Appendix 6.8.I2 / variable 'Pcorpnipa'
  XS002-G <- Appendix 6.8.I2 / variable 's'
