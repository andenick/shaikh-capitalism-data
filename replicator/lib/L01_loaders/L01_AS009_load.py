"""L01_AS009_load — load Shaikh Appendix 6.8 columns for AS009 (IRS Corporate Inventories and Total Capital Stock).
...
NIPA / BEA FA / IRS / Census components are documented in AS009_EPR.md.

Source map (subseries_id -> (Appendix table, variable, scale)):
  AS009-A <- Appendix 6.8.II6 / variable 'INVcorp'
  AS009-B <- Appendix 6.8.II6 / variable 'KGCcorp'
  AS009-C <- Appendix 6.8.II6 / variable 'KTCcorp'

Units: billions_current_usd
Book year range: [1946, 2011]
"""
...
SOURCE_MAP = {'AS009-A': ['II6', 'INVcorp', 1.0], 'AS009-B': ['II6', 'KGCcorp', 1.0], 'AS009-C': ['II6', 'KTCcorp', 1.0]}
