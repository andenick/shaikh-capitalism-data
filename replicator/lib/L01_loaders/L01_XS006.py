...
Source map (subseries_id -> (Appendix table, variable, scale)):
  XS006-depr_only <- Appendix 6.8.II3 / variable 'KNCcorpnew'
  XS006-depr_plus_init <- Appendix 6.8.II3 / variable 'KNCbea93'
  XS006-dcorpnew <- Appendix 6.8.II3 / variable 'dcorpnew'
