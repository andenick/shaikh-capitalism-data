"""L01_AS001 — load Shaikh Appendix 6.8 columns for XS001 (GDP/GDI Decomposition and Business NOS).
...
NIPA / BEA FA / IRS / Census components are documented in XS001_EPR.md.

Source map (subseries_id -> (Appendix table, variable, scale)):
  XS001-A <- Appendix 6.8.I1 / variable 'NOSbusnipa'
  XS001-B <- Appendix 6.8.I1 / variable 'Aggregate NOSnipa'
  XS001-C <- Appendix 6.8.I1 / variable 'NOShh'
  XS001-D <- Appendix 6.8.I1 / variable 'NOSnpish'
  XS001-E <- Appendix 6.8.I1 / variable 'NOSgengov'
  XS001-F <- Appendix 6.8.I1 / variable 'NOSgoventerp'
...
SOURCE_MAP = {'XS001-A': ['I1', 'NOSbusnipa', 1.0], 'XS001-B': ['I1', 'Aggregate NOSnipa', 1.0], 'XS001-C': ['I1', 'NOShh', 1.0], 'XS001-D': ['I1', 'NOSnpish', 1.0], 'XS001-E': ['I1', 'NOSgengov', 1.0], 'XS001-F': ['I1', 'NOSgoventerp', 1.0]}
