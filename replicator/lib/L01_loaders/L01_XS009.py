"""L01_AS009 — load Shaikh Appendix 6.8 columns for XS009 (IRS Corporate Inventories and Total Capital Stock).
...
NIPA / BEA FA / IRS / Census components are documented in XS009_EPR.md.

Source map (subseries_id -> (Appendix table, variable, scale)):
  XS009-A <- Appendix 6.8.II6 / variable 'INVcorp'
  XS009-B <- Appendix 6.8.II6 / variable 'KGCcorp'
  XS009-C <- Appendix 6.8.II6 / variable 'KTCcorp'
...
SOURCE_MAP = {'XS009-A': ['II6', 'INVcorp', 1.0], 'XS009-B': ['II6', 'KGCcorp', 1.0], 'XS009-C': ['II6', 'KTCcorp', 1.0]}
