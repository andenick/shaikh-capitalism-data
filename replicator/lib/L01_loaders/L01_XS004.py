"""L01_AS004 — load Shaikh Appendix 6.8 columns for XS004 (GPIM Corporate Capital Stock (Operational Baseline)).
...
NIPA / BEA FA / IRS / Census components are documented in XS004_EPR.md.

Source map (subseries_id -> (Appendix table, variable, scale)):
  XS004-A <- Appendix 6.8.II5 / variable 'KNCcorp'
  XS004-B <- Appendix 6.8.II5 / variable 'KGCcorp'
  XS004-C <- Appendix 6.8.II5 / variable 'KNHcorp'
...
SOURCE_MAP = {'XS004-A': ['II5', 'KNCcorp', 1.0], 'XS004-B': ['II5', 'KGCcorp', 1.0], 'XS004-C': ['II5', 'KNHcorp', 1.0]}
