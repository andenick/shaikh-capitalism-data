"""L01_AS001_load — load Shaikh Appendix 6.8 columns for AS001 (GDP/GDI Decomposition and Business NOS).
...
NIPA / BEA FA / IRS / Census components are documented in AS001_EPR.md.

Source map (subseries_id -> (Appendix table, variable, scale)):
  AS001-A <- Appendix 6.8.I1 / variable 'NOSbusnipa'
  AS001-B <- Appendix 6.8.I1 / variable 'Aggregate NOSnipa'
  AS001-C <- Appendix 6.8.I1 / variable 'NOShh'
  AS001-D <- Appendix 6.8.I1 / variable 'NOSnpish'
  AS001-E <- Appendix 6.8.I1 / variable 'NOSgengov'
  AS001-F <- Appendix 6.8.I1 / variable 'NOSgoventerp'
...
SOURCE_MAP = {'AS001-A': ['I1', 'NOSbusnipa', 1.0], 'AS001-B': ['I1', 'Aggregate NOSnipa', 1.0], 'AS001-C': ['I1', 'NOShh', 1.0], 'AS001-D': ['I1', 'NOSnpish', 1.0], 'AS001-E': ['I1', 'NOSgengov', 1.0], 'AS001-F': ['I1', 'NOSgoventerp', 1.0]}
