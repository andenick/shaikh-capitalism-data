"""L01_S710_load — US industry IROP DEVIATIONS panel, 1988-2005 (derived from S706 xlsx)."""
...
OUT = DATA_RAW / f"{SERIES_ID}_SHAIKH_APX7_IROP_DEV.parquet"
...
def run() -> dict:
    ...
    return {
        "status": "OK",
        "rows_loaded": {"shaikh_apx7_irop_dev": int(len(long_df))},
