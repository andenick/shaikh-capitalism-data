"""V03_ES2304 — verify processed XS2304 matches the reconstructed CSV."""
...
def run() -> dict:
    ...
    row = {
        ...
        "comparison_basis": "Reconstructed XS2304_literature_compilation.csv (verbatim named endpoints from paper note 17)",
        "n_compared": n,
        "mae": round(mae, 6),
