"""V03_ES2302 — anchor-based validation of XS2302 CA balance.
...
ANCHORS = [
    (2008, "XS2302-level", 420.0, "Fig 2 left axis peak ~ 420 USD bn"),
    (2007, "XS2302-pctgdp", 10.0, "Fig 2 right axis + Section 1 p. 432 ~10% peak"),
]
