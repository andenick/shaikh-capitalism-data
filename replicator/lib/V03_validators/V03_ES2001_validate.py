"""V03_ES2001_validate — verify ES2001 matches reconstructed Tables 1-2."""
...
def run() -> dict:
    ...
    row = {
        ...
        "comparison_basis": "Reconstructed ES2001_aggregate_ratios.csv (verbatim Shaikh 2020 Tables 1-2)",
        "n_compared": n,
        "mae": round(mae, 6),
