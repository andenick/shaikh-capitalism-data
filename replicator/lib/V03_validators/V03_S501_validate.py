"""V03_S501_validate - compare processed S501 against Appendix5_DATALRprices columns."""
...
def _update(row: dict) -> None:
    ...
    rpt.setdefault("series", {})["S501"] = row
...
def run() -> dict:
    ...
    overall_div = 0
    overall_mae = []
    for sub_id, col in [("S501-A", "USWPI"), ("S501-B", "UKWPI")]:
