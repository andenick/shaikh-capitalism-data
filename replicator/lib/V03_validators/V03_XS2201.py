"""V03_ES2201 — verify XS2201 matches reconstructed Table 1."""
...
def _resolve_csv() -> Path:
    """Resolve the truth CSV, tolerating the ES/XS filename split.
...
def run() -> dict:
    ...
    row = {
        ...
        "comparison_basis": "Reconstructed XS2201_fitted_parameters.csv (verbatim Shaikh-Jacobo 2020 Table 1)",
        "n_compared": n,
        "mae": round(mae, 6),
