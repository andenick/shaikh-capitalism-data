"""V03_S1602_validate - compare S1602 to Appendix 16 WageProdData."""
...
PROCESSED = DATA_PROCESSED / "S1602.parquet"
REPORT = paths.TECHNICAL / "VALIDATION_REPORT.json"
VALIDATOR_TOL_PCT = 1.0
BOOK_OVERLAP = (1947, 2012)

SUBS = [
    ("S1602-A", "Productivity 1982=100"),
    ("S1602-B", "Real Hrly EC 1982=100"),
    ("S1602-C", "Adj Real Hrly EC"),
    ("S1602-G", "Productivity 1958=100"),
    ("S1602-H", "Real Hrly EC 1958=100"),
]
...
def _update_report(row: dict) -> None:
    ...
    rpt.setdefault("series", {})["S1602"] = row
...
def run() -> dict:
    ...
    truth = read_appendix16_wage_prod()
