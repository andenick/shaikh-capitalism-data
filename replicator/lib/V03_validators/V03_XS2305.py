"""V03_ES2305 — verify processed XS2305 matches the reconstructed CSV."""
...
def run() -> dict:
    ...
    row = {
        ...
        "comparison_basis": "Reconstructed XS2305_literature_compilation.csv (verbatim named endpoints)",
        "n_compared": n,
        "mae": round(mae, 6),
