...
- `XS2001_aggregate_ratios.csv` — Tables 1 (circulating capital) and 2 (fixed
...
regeneration is deferred — see `XS2001_EPR.md` for the rationale and
