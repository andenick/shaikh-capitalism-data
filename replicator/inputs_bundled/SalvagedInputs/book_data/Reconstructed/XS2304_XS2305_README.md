# XS2304 / XS2305 Literature-Compilation Data
...
- `XS2304_literature_compilation.csv` — extended PPP estimates (Fig 4)
- `XS2305_literature_compilation.csv` — macroeconomic balance estimates (Fig 5)
...
- Fig 4 (XS2304): high = +50% (Coudert and Couharde 2007, via
  Cline-Williamson 2007 review); low = -36% (Cheung 2012)
- Fig 5 (XS2305): high = +40% (Goldstein 2004, via Cline-Williamson 2007
...
This is documented in `XS2304_EPR.md` and `XS2305_EPR.md` under the
